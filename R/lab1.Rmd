...
print(result)
```
In general, a lower test MSE indicates that the model generalizes better.
Higher degrees of freedom mean that models are more flexible and tend to fit details in the data, but can lead to overfitting; Lower degrees of freedom mean that the model is smoother, limiting the fit to the training data.
