...
#Conditon1
Compute the misclassification error in the same test dataset of size 1000. Report results for when the random forest has 1, 10 and 100 trees.
```{r example 1-1}
error_rate_1<- list(
  number1 = rep(0,1000),
  number2 = rep(0,1000),
...
#change the conditions of x1/x2 (condition2)
```{r example 1-3}
error_rate_2<- list(
  number1 = rep(0,1000),
  number2 = rep(0,1000),
...
#change the conditions of x1/x2 and nodesize (condition3)
```{r example 1-5}
error_rate_3<- list(
  number1 = rep(0,1000),
  number2 = rep(0,1000),
